...
static const uint8_t MIN_TEMPERATURE = 10;     // Minimum temperature as reported by Panasonic app
static const uint8_t MAX_TEMPERATURE = 35;     // Maximum temperature as supported by Panasonic app
